...
public class StormKafkaMain {
    private static final String KAFKA_TOPIC ="lab6";
    private static final String KAFKA_TOPIC_B ="lab6output";
    ...
    private static StormTopology createTopology()
    {
      ...
      /*  topology.setBolt("SplitSentence", new SplitSentenceBolt(), 4)
        ...
        topology.setBolt("FirstBolt", bolt, 8).shuffleGrouping("kafka_spout");
        topology.setBolt("SecondBolt", bolt, 8).shuffleGrouping("kafka_spout");
        topology.setBolt("ThirdBolt", bolt, 8).shuffleGrouping("FirstBolt").shuffleGrouping("SecondBolt");
